...
export default function WonCard({ ele, wonAuctions, t, lang }) {
    ...
    return (
        <>
            <li
            // className={wonAuctions.length > 1 ? "" : "full"}
            >
                <Link
                    to={`/${
                        ele?.property_for === 2 &&
                        ele?.purchase_forefit_status &&
                        ele?.purchase_forefit_status !== 2
                            ? "auction-winner"
                            : "property/detail"
                ...
                >
                    <div className="won-box">
                        <figure>
                            ...
                            <img
                                src={
                                    ele?.property_image?.bucket_name &&
                                    ele?.property_image?.image
                            ...
                            <div className="won-tag">
                                <img src="/img/won-tag.svg" alt="won tag" />
                            </div>
                        ...
                        <figcaption>
                            ...
                            {ele?.purchase_forefit_status === 2 ? (
                                <div className="bottom">
                                    <small>{t("Highest Bid")}</small>
                                    <h5>
                                        {formatPrice(ele?.highest_bid || 0)}
                                    </h5>
                                </div>
                            ) : (
                                <h6>
